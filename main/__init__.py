...
db = SQLAlchemy(session_options={"autoflush": False})  # Generate a db instance and bind it to the app

sqlalchemy_db_uri = "mysql+pymysql://" + dbms_usr + ":" + dbms_pwd + "@" + dbms_addr + ":" + dbms_port + "/" + dbms_db
